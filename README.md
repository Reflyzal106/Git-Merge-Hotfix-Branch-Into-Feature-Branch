# [SOLVED] Git-Merge-Hotfix-Branch-Into-Feature-Branch
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/git-merge-hotfix-branch-into-feature-branch)
>
...
To merge the hotfix branch into the feature branch, use the following steps: git checkout feature1, then git merge --no-ff hotfix, and finally git push origin feature1
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/git-merge-hotfix-branch-into-feature-branch)**
